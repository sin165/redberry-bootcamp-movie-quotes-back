...
<body>
  <div class="container">
    ...
    <main>
      ...
      <p><span>Thanks for joining Movie quotes! We really appreciate it. Please click the button below to verify your account:</span></p>
      <a href="{{ $url }}" class="link"><span>Verify account</span></a>
